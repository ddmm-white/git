( function ( $ )
{
	...
	var FilterView = Backbone.View.extend( {
		...
		render: function ()
		{
			...
			watermark( $( this.el ).find( 'input[type="text"]' ), this.watermarkText );
			return this;
		},
		submit: function ( e )
		{
			...
			if ( data.name == this.watermarkText )
			{
				data.name = "";
			}
			$( '#main-container' ).trigger( 'refreshCollection', data );
		}
	} );
	...
	var DirectoryView = Backbone.View.extend( {
		...
		refreshCollection: function ( ev, data )
		{
			this.remove();
			getData( data );
		}
	...
	{
		$element.val( text ).addClass( 'watermark' );
